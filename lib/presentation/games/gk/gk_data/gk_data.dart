class GkQuestion {
  ...
  bool answerdCorrectly =
      false; // New property to track if the question was answered correctly
...
final List<GkQuestion> hardQuestions = [
  ...
  GkQuestion(
    ...
    options: {
      "He has written the letter.": true,
      "He wrote the letter.": false,
      "The letter wrote him.": false,
      "Written by him is the letter.": false,
    },
  ),
  GkQuestion(
    question:
