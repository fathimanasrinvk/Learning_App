...
class GameScreen extends StatelessWidget {
  ...
  var screens = [
    ...
    LevelScreen(easy: PuzzleScreen(words: DbData.easy, level: 'easy',), medium: PuzzleScreen(words: DbData.medium, level: 'medium',),
        hard: PuzzleScreen(words: DbData.hard, level: 'hard',)),
