...
class PuzzleMediumScreen extends StatefulWidget {
  const PuzzleMediumScreen({super.key});

  @override
  State<PuzzleMediumScreen> createState() => _PuzzleMediumScreenState();
}

class _PuzzleMediumScreenState extends State<PuzzleMediumScreen> {
  int currentIndex = 0;
